            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 text-center space-y-5 shadow-sm border border-zinc-200 my-4">
              ...
              {waGroupUrl && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs sm:text-sm rounded-xl transition-all shadow-md hover:shadow-lg"
                >
